...
collected by the agent with respect to the randomness in the system.This leads to the so called \textit{risk-neutral} behavior.
...
state that allows to reformulate the Lagrangian objective function as an MDP and still,
they need to make use of several approximations to allow the algorithm be fully incremental and 
...
literature, \textit{Batch RL} or \textit{offline RL} setting. \todo{recheck}
...
We think that our algorithm ... \todo{final motivation sentence}